...
const useChat = ({ repoContext, repoMeta, oauthUser }) => {
...
const ChatbotPanel = ({ onClose, repoContext, repoMeta, oauthUser }) => {
  const chatLogic = useChat({ repoContext, repoMeta, oauthUser });
